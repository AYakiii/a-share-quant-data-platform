...
SOURCE_CAPABILITY_REGISTRY: list[SourceCapabilitySpec] = [
    ...
    SourceCapabilitySpec("financial_analysis_indicator_raw", "akshare", "financial_fundamental", "stock_financial_analysis_indicator_em", "stock_financial_analysis_indicator_em", "report_period", "symbol+indicator", ("symbol", "indicator"), "REPORT_DATE", "SECUCODE/SECURITY_CODE", "REPORT_DATE", "NOTICE_DATE", "", "", "REPORT_DATE must not be used as PIT availability time; use NOTICE_DATE", 1, "Manual-only recovered Eastmoney financial analysis indicator source; raw-only in this PR with no normalized/factor target; partitions retain six-digit symbol and stable indicator labels."),
    SourceCapabilitySpec("balance_sheet_statement_raw", "akshare", "financial_fundamental", "stock_balance_sheet_by_report_em", "stock_balance_sheet_by_report_em", "report_period", "financial_statement_symbol", ("symbol",), "REPORT_DATE", "SECUCODE/SECURITY_CODE", "REPORT_DATE", "NOTICE_DATE", "", "", "Raw wide financial statement; preserve AkShare columns unchanged and do not apply normalized PIT logic.", 1, "P1 financial statement raw source; AkShare symbol is SH/SZ-prefixed while partition keeps logical six-digit symbol."),
    SourceCapabilitySpec("profit_sheet_statement_raw", "akshare", "financial_fundamental", "stock_profit_sheet_by_report_em", "stock_profit_sheet_by_report_em", "report_period", "financial_statement_symbol", ("symbol",), "REPORT_DATE", "SECUCODE/SECURITY_CODE", "REPORT_DATE", "NOTICE_DATE", "", "", "Raw wide financial statement; preserve AkShare columns unchanged and do not apply normalized PIT logic.", 1, "P1 financial statement raw source; AkShare symbol is SH/SZ-prefixed while partition keeps logical six-digit symbol."),
    SourceCapabilitySpec("cash_flow_statement_raw", "akshare", "financial_fundamental", "stock_cash_flow_sheet_by_report_em", "stock_cash_flow_sheet_by_report_em", "report_period", "financial_statement_symbol", ("symbol",), "REPORT_DATE", "SECUCODE/SECURITY_CODE", "REPORT_DATE", "NOTICE_DATE", "", "", "Raw wide financial statement; preserve AkShare columns unchanged and do not apply normalized PIT logic.", 1, "P1 financial statement raw source; AkShare symbol is SH/SZ-prefixed while partition keeps logical six-digit symbol."),
    SourceCapabilitySpec("balance_sheet_summary_raw", "akshare", "financial_fundamental", "stock_zcfz_em", "stock_zcfz_em", "report_period", "financial_statement_report_date", ("report_date",), "report_date(input)", "股票代码", "report_date(input)", "公告日期", "", "", "Raw report-date financial statement summary; preserve AkShare columns unchanged and do not apply normalized PIT logic.", 1, "P1 full-market financial statement summary keyed by logical report_date."),
    SourceCapabilitySpec("profit_sheet_summary_raw", "akshare", "financial_fundamental", "stock_lrb_em", "stock_lrb_em", "report_period", "financial_statement_report_date", ("report_date",), "report_date(input)", "股票代码", "report_date(input)", "公告日期", "", "", "Raw report-date financial statement summary; preserve AkShare columns unchanged and do not apply normalized PIT logic.", 1, "P1 full-market financial statement summary keyed by logical report_date."),
    SourceCapabilitySpec("cash_flow_summary_raw", "akshare", "financial_fundamental", "stock_xjll_em", "stock_xjll_em", "report_period", "financial_statement_report_date", ("report_date",), "report_date(input)", "股票代码", "report_date(input)", "公告日期", "", "", "Raw report-date financial statement summary; preserve AkShare columns unchanged and do not apply normalized PIT logic.", 1, "P1 full-market financial statement summary keyed by logical report_date."),
    ...
    SourceCapabilitySpec("concept_fund_flow_raw", "akshare", "market_sentiment", "stock_fund_flow_concept", "stock_fund_flow_concept", "snapshot", "manual_selected_snapshot", ("snapshot",), "", "", "", "", "raw_only", "concept_fund_flow", "", 4, "P1.5 recovered candidate; default_enabled=false and manual_review_required=true in raw ingest policy."),
    SourceCapabilitySpec("industry_fund_flow_raw", "akshare", "market_sentiment", "stock_fund_flow_industry", "stock_fund_flow_industry", "snapshot", "manual_selected_snapshot", ("snapshot",), "", "", "", "", "raw_only", "industry_fund_flow", "", 4, "P1.5 recovered candidate; default_enabled=false and manual_review_required=true in raw ingest policy."),
    SourceCapabilitySpec("hsgt_fund_flow_summary_raw", "akshare", "market_sentiment", "stock_hsgt_fund_flow_summary_em", "stock_hsgt_fund_flow_summary_em", "snapshot", "manual_selected_snapshot", ("snapshot",), "", "", "", "", "raw_only", "northbound_southbound_fund_flow", "", 4, "P1.5 recovered candidate; default_enabled=false and manual_review_required=true in raw ingest policy."),
    SourceCapabilitySpec("commodity_inventory_em_raw", "akshare", "commodity_inventory", "futures_inventory_em", "futures_inventory_em", "snapshot", "manual_selected_snapshot", ("snapshot",), "", "", "", "", "raw_only", "commodity_inventory", "", 4, "P2 recovered candidate; default_enabled=false and manual_review_required=true in raw ingest policy."),
    SourceCapabilitySpec("comex_inventory_raw", "akshare", "commodity_inventory", "futures_comex_inventory", "futures_comex_inventory", "snapshot", "manual_selected_snapshot", ("snapshot",), "", "", "", "", "raw_only", "global_commodity_inventory", "", 4, "P2 recovered candidate; default_enabled=false and manual_review_required=true in raw ingest policy."),
    SourceCapabilitySpec("gfex_warehouse_receipt_raw", "akshare", "commodity_inventory", "futures_gfex_warehouse_receipt", "futures_gfex_warehouse_receipt", "daily", "trade_date", ("trade_date",), "trade_date(input)", "product_key", "", "", "raw_only", "commodity_warehouse_receipt", "", 4, "P2 recovered dict[str, DataFrame] candidate flattened with product_key/source_api/exchange/trade_date; disabled by default."),
    SourceCapabilitySpec("shfe_warehouse_receipt_raw", "akshare", "commodity_inventory", "futures_shfe_warehouse_receipt", "futures_shfe_warehouse_receipt", "daily", "trade_date", ("trade_date",), "trade_date(input)", "product_key", "", "", "raw_only", "commodity_warehouse_receipt", "", 4, "P2 recovered dict[str, DataFrame] candidate flattened with product_key/source_api/exchange/trade_date; disabled by default."),
    SourceCapabilitySpec("czce_warehouse_receipt_raw", "akshare", "commodity_inventory", "futures_warehouse_receipt_czce", "futures_warehouse_receipt_czce", "daily", "trade_date", ("trade_date",), "trade_date(input)", "product_key", "", "", "raw_only", "commodity_warehouse_receipt", "", 4, "P2 recovered dict[str, DataFrame] candidate flattened with product_key/source_api/exchange/trade_date; disabled by default."),
]
...
FACTOR_SOURCE_REGISTRY: list[SourceCase] = [
    ...
    SourceCase("financial_analysis_indicator_em_raw__000001__report_period", "financial_fundamental", "stock_financial_analysis_indicator_em", {"symbol": "000001", "indicator": "按报告期"}, "manual-only recovered EM financial analysis indicator candidate", enabled=False),
    SourceCase("balance_sheet_statement_raw__600519", "financial_fundamental", "stock_balance_sheet_by_report_em", {"symbol": "600519"}, "P1 raw balance sheet wide statement probe"),
    SourceCase("profit_sheet_statement_raw__600519", "financial_fundamental", "stock_profit_sheet_by_report_em", {"symbol": "600519"}, "P1 raw profit sheet wide statement probe"),
    SourceCase("cash_flow_statement_raw__600519", "financial_fundamental", "stock_cash_flow_sheet_by_report_em", {"symbol": "600519"}, "P1 raw cash flow wide statement probe"),
    SourceCase("balance_sheet_summary_raw__20240331", "financial_fundamental", "stock_zcfz_em", {"date": "20240331"}, "P1 raw balance sheet full-market report-date summary probe"),
    SourceCase("profit_sheet_summary_raw__20240331", "financial_fundamental", "stock_lrb_em", {"date": "20240331"}, "P1 raw profit sheet full-market report-date summary probe"),
    SourceCase("cash_flow_summary_raw__20240331", "financial_fundamental", "stock_xjll_em", {"date": "20240331"}, "P1 raw cash flow full-market report-date summary probe"),
    SourceCase("concept_fund_flow_raw__manual_snapshot", "market_sentiment", "stock_fund_flow_concept", {}, "manual-only P1.5 recovered concept fund-flow candidate", enabled=False),
    SourceCase("industry_fund_flow_raw__manual_snapshot", "market_sentiment", "stock_fund_flow_industry", {}, "manual-only P1.5 recovered industry fund-flow candidate", enabled=False),
    SourceCase("hsgt_fund_flow_summary_raw__manual_snapshot", "market_sentiment", "stock_hsgt_fund_flow_summary_em", {}, "manual-only P1.5 recovered HSGT fund-flow summary candidate", enabled=False),
    SourceCase("commodity_inventory_em_raw__manual_snapshot", "commodity_inventory", "futures_inventory_em", {}, "manual-only P2 recovered commodity inventory candidate", enabled=False),
    SourceCase("comex_inventory_raw__manual_snapshot", "commodity_inventory", "futures_comex_inventory", {}, "manual-only P2 recovered COMEX inventory candidate", enabled=False),
    SourceCase("gfex_warehouse_receipt_raw__manual_20240102", "commodity_inventory", "futures_gfex_warehouse_receipt", {"date": "20240102"}, "manual-only P2 recovered GFEX warehouse receipt candidate", enabled=False),
    SourceCase("shfe_warehouse_receipt_raw__manual_20240102", "commodity_inventory", "futures_shfe_warehouse_receipt", {"date": "20240102"}, "manual-only P2 recovered SHFE warehouse receipt candidate", enabled=False),
    SourceCase("czce_warehouse_receipt_raw__manual_20240102", "commodity_inventory", "futures_warehouse_receipt_czce", {"date": "20240102"}, "manual-only P2 recovered CZCE warehouse receipt candidate", enabled=False),
]
