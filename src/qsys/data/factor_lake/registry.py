...
SOURCE_CAPABILITY_REGISTRY: list[SourceCapabilitySpec] = [
    ...
    SourceCapabilitySpec("financial_analysis_indicator_raw", "akshare", "financial_fundamental", "stock_financial_analysis_indicator_em", "fetch_stock_financial_analysis_indicator_em", "report_period", "symbol+indicator", ("symbol", "indicator"), "报告期", "symbol(input->000001.SZ/600000.SH)", "报告期", "", "", "", "manual raw-only; no normalized/factor target in this PR", 1, "Manual-only recovered Eastmoney financial analysis indicator source; partitions retain six-digit symbol and stable indicator labels."),
