...
from qsys.data.factor_lake.akshare_raw_ingest import run_akshare_raw_ingest_official
...
def run_p0_wave(args: argparse.Namespace, ingest_fn: Callable[..., dict[str, Any]] = run_akshare_raw_ingest_official) -> dict[str, Path]:
